...
<div class="nav__actions">
   ...
   <div class="nav__toggle" id="nav-toggle">
    ...
    <div class="list-carousel-anime">
        <h1 class="bagian-list">Attack on Titan</h1>
        <div class="posisi">
            <div class="foto-list">
                <img src="img/aot.jpg" alt="Attack on Titan">
                <div class="favorit-box" data-judul="Attack on Titan" onclick="tambahFavorit(this)">
                <span>Tambah ke Favorit</span>
                </div>
            </div>
            <div class="keterangan">
                <p class="anime-list-ket"><span>Judul  :</span> Attack on Titan</p>
