...
<div class="nav__actions">
   ...
   <div class="nav__toggle" id="nav-toggle">
    ...
    <div class="list-carousel-anime">
        <h1 class="bagian-list">Date A Life</h1>
        <div class="posisi">
            <div class="foto-list">
                <img src="img/datealive.jpg" alt="Date A Life">
                <div class="favorit-box" data-judul="Date A Life" onclick="tambahFavorit(this)">
                <span>Tambah ke Favorit</span>
                </div>
            </div>
            <div class="keterangan">
                <p class="anime-list-ket"><span>Judul  :</span> Date A Life</p>
