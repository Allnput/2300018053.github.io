...
<div class="nav__actions">
   ...
   <div class="nav__toggle" id="nav-toggle">
    ...
    <div class="list-carousel-anime">
        <h1 class="bagian-list">Dr. Stone</h1>
        <div class="posisi">
            <div class="foto-list">
                <img src="img/dr_stone.jpg" alt="Dr. Stone">
                <div class="favorit-box" data-judul="Dr. Stone" onclick="tambahFavorit(this)">
                <span>Tambah ke Favorit</span>
                </div>
            </div>
            <div class="keterangan">
                <p class="anime-list-ket"><span>Judul  :</span> Dr. Stone</p>
