...
<div class="nav__actions">
   ...
   <div class="nav__toggle" id="nav-toggle">
    ...
    <div class="list-carousel-anime">
        <h1 class="bagian-list">JUJUTSU KAISEN</h1>
        <div class="posisi">
            <div class="foto-list">
                <img src="img/jjk.jpg" alt="jujutsu kaisen">
                <div class="favorit-box" data-judul="Jujutsu Kaisen" onclick="tambahFavorit(this)">
                <span>Tambah ke Favorit</span>
                </div>
            </div>
            <div class="keterangan">
                <p class="anime-list-ket"><span>Judul  :</span> Jujutsu Kaisen</p>
                ...
                <p class="anime-list-ket"><span>Skor   :</span> 8.82</p>
