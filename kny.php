...
<div class="nav__actions">
   ...
   <div class="nav__toggle" id="nav-toggle">
    ...
    <div class="list-carousel-anime">
        <h1 class="bagian-list">KIMETSU NO YAIBA:HASHIRA GEIKO-HEN</h1>
        <div class="posisi">
            <div class="foto-list">
                <img src="img/kny.jpg" alt="Kimetsu no Yaiba">
                <div class="favorit-box" data-judul="Kimetsu no Yaiba: Hashira Geiko-hen" onclick="tambahFavorit(this)">
                <span>Tambah ke Favorit</span>
                </div>
            </div>
            <div class="keterangan">
                <p class="anime-list-ket"><span>Judul  :</span> Kimetsu no Yaiba: Hashira Geiko-hen</p>
