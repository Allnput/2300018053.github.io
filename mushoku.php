...
<div class="nav__actions">
   ...
   <div class="nav__toggle" id="nav-toggle">
    ...
    <div class="list-carousel-anime">
        <h1 class="bagian-list">MUSHOKU TENSEI</h1>
        <div class="posisi">
            <div class="foto-list">
                <img src="img/moushoku tensei.jpg" alt="Mushoku Tensei">
                <div class="favorit-box" data-judul="Mushoku Tensei" onclick="tambahFavorit(this)">
                <span>Tambah ke Favorit</span>
                </div>
            </div>
            <div class="keterangan">
                <p class="anime-list-ket"><span>Judul  :</span> Mushoku Tensei</p>
