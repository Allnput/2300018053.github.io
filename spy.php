...
<div class="nav__actions">
   ...
   <div class="nav__toggle" id="nav-toggle">
    ...
    <div class="list-carousel-anime">
        <h1 class="bagian-list">SPY X FAMILY</h1>
        <div class="posisi">
            <div class="foto-list">
                <img src="img/spy.jpg" alt="spy">
                <div class="favorit-box" data-judul="Spy X Family" onclick="tambahFavorit(this)">
                <span>Tambah ke Favorit</span>
                </div>
            </div>
            <div class="keterangan">
                <p class="anime-list-ket"><span>Judul  :</span> Spy X Family</p>
