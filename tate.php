...
<div class="nav__actions">
   ...
   <div class="nav__toggle" id="nav-toggle">
    ...
    <div class="list-carousel-anime">
        <h1 class="bagian-list">TATE NO YUSHA</h1>
        <div class="posisi">
            <div class="foto-list">
                <img src="img/tatenoyusha.jpg" alt="tate">
                <div class="favorit-box" data-judul="Tate No Yusha" onclick="tambahFavorit(this)">
                <span>Tambah ke Favorit</span>
                </div>
            </div>
            <div class="keterangan">
                <p class="anime-list-ket"><span>Judul  :</span> Tate No Yusha</p>
