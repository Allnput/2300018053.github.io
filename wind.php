...
<div class="nav__actions">
   ...
   <div class="nav__toggle" id="nav-toggle">
    ...
    <div class="list-carousel-anime">
        <h1 class="bagian-list">WIND BREAKER</h1>
        <div class="posisi">
            <div class="foto-list">
                <img src="img/windbreaker.jpg" alt="wind">
                <div class="favorit-box" data-judul="Wind Breaker" onclick="tambahFavorit(this)">
                <span>Tambah ke Favorit</span>
                </div>
            </div>
            <div class="keterangan">
                <p class="anime-list-ket"><span>Judul  :</span> Wind Breaker</p>
